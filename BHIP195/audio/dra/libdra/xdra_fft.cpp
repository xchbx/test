...
static void xdra_fft_process_2(const uint16_t ido, const uint16_t l1, const complex_t *cc, complex_t *ch, const complex_t *wa);
static void xdra_fft_process_3(const uint16_t ido, const uint16_t l1, const complex_t *cc, complex_t *ch, const complex_t *wa1, const complex_t *wa2, const int8_t isign);
static void xdra_fft_process_4(const uint16_t ido, const uint16_t l1, const complex_t *cc, complex_t *ch, const complex_t *wa1, const complex_t *wa2, const complex_t *wa3);
static void xdra_fft_process_5(const uint16_t ido, const uint16_t l1, const complex_t *cc, complex_t *ch, const complex_t *wa1, const complex_t *wa2, const complex_t *wa3,
							   const complex_t *wa4, const int8_t isign);


static inline void xdra_fft_process_1(uint16_t n, complex_t *c, complex_t *ch,
                             ...
                             const int8_t isign)
{
    ...
    for (k1 = 2; k1 <= nf+1; k1++)
    {
        ...
        case 4:
            ...
            if (na == 0)
                xdra_fft_process_4((const uint16_t)ido, (const uint16_t)l1, (const complex_t*)c, ch, &wa[iw], &wa[ix2], &wa[ix3]);
            else
                xdra_fft_process_4((const uint16_t)ido, (const uint16_t)l1, (const complex_t*)ch, c, &wa[iw], &wa[ix2], &wa[ix3]);

            na = 1 - na;
            break;
        case 2:
            if (na == 0)
                xdra_fft_process_2((const uint16_t)ido, (const uint16_t)l1, (const complex_t*)c, ch, &wa[iw]);
            else
                xdra_fft_process_2((const uint16_t)ido, (const uint16_t)l1, (const complex_t*)ch, c, &wa[iw]);
        ...
        case 3:
            ...
            if (na == 0)
                xdra_fft_process_3((const uint16_t)ido, (const uint16_t)l1, (const complex_t*)c, ch, &wa[iw], &wa[ix2], isign);
            else
                xdra_fft_process_3((const uint16_t)ido, (const uint16_t)l1, (const complex_t*)ch, c, &wa[iw], &wa[ix2], isign);
        ...
        case 5:
            ...
            if (na == 0)
                xdra_fft_process_5((const uint16_t)ido, (const uint16_t)l1, (const complex_t*)c, ch, &wa[iw], &wa[ix2], &wa[ix3], &wa[ix4], isign);
            else
                xdra_fft_process_5((const uint16_t)ido, (const uint16_t)l1, (const complex_t*)ch, c, &wa[iw], &wa[ix2], &wa[ix3], &wa[ix4], isign);
...
static void xdra_fft_process_2(const uint16_t ido, const uint16_t l1, const complex_t *cc,
...
static void xdra_fft_process_3(const uint16_t ido, const uint16_t l1, const complex_t *cc,
...
static void xdra_fft_process_4(const uint16_t ido, const uint16_t l1, const complex_t *cc,
                      complex_t *ch, const complex_t *wa1, const complex_t *wa2,
                      const complex_t *wa3)
{
    uint16_t i, k, ac, ah;
...
static void xdra_fft_process_5(const uint16_t ido, const uint16_t l1, const complex_t *cc,
...
{
    xdra_fft_process_1(fft->n, c, fft->work, (const uint16_t*)fft->ifac, (const complex_t*)fft->tab, +1);
}

static void init(uint16_t n, complex_t *wa, uint16_t *ifac)
{
...
{
    xdra_fft *fft = (xdra_fft*)xdra_malloc(sizeof(xdra_fft));
    fft->n = n;
    fft->work = (complex_t*)xdra_malloc(n*sizeof(complex_t));
    fft->tab = (complex_t*)xdra_malloc(n*sizeof(complex_t));
